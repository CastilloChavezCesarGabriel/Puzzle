...
class HeuristicTest(unittest.TestCase):
    ...
    def test_concrete_subclasses_share_size_contract(self):
        ...
        self.assertEqual(ManhattanDistanceAlgorithm(3).estimate(solved), NoHeuristic(3).estimate(solved))

    def test_concrete_subclasses_diverge_on_unsolved_state(self):
        unsolved = (1, 2, 3, 4, 5, 6, 7, 0, 8)
        self.assertNotEqual(ManhattanDistanceAlgorithm(3).estimate(unsolved), NoHeuristic(3).estimate(unsolved))
