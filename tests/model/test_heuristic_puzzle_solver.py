...
class HeuristicPuzzleSolverTest(unittest.TestCase):
    def test_solves_already_solved_2x2(self):
        puzzle = Puzzle(2)
        self.assertIsNone(SolutionPath(HeuristicPuzzleSolver(ManhattanDistance(2)).solve(puzzle)).solves(puzzle))

    def test_solves_already_solved_3x3(self):
        puzzle = Puzzle(3)
        self.assertIsNone(SolutionPath(HeuristicPuzzleSolver(ManhattanDistance(3)).solve(puzzle)).solves(puzzle))

    def test_solves_already_solved_4x4(self):
        puzzle = Puzzle(4)
        self.assertIsNone(SolutionPath(HeuristicPuzzleSolver(ManhattanDistance(4)).solve(puzzle)).solves(puzzle))

    def test_solves_already_solved_5x5(self):
        puzzle = Puzzle(5)
        self.assertIsNone(SolutionPath(HeuristicPuzzleSolver(ManhattanDistance(5)).solve(puzzle)).solves(puzzle))
