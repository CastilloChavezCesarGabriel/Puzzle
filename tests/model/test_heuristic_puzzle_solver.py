...
class HeuristicPuzzleSolverTest(unittest.TestCase):
    def test_solves_already_solved_2x2(self):
        puzzle = Puzzle(2)
        self.assertIsNone(SolutionPath(HeuristicPuzzleSolver(ManhattanDistance(2)).solve(puzzle)).verify(puzzle))

    def test_solves_already_solved_3x3(self):
        puzzle = Puzzle(3)
        self.assertIsNone(SolutionPath(HeuristicPuzzleSolver(ManhattanDistance(3)).solve(puzzle)).verify(puzzle))

    def test_solves_already_solved_4x4(self):
        puzzle = Puzzle(4)
        self.assertIsNone(SolutionPath(HeuristicPuzzleSolver(ManhattanDistance(4)).solve(puzzle)).verify(puzzle))

    def test_solves_already_solved_5x5(self):
        puzzle = Puzzle(5)
        self.assertIsNone(SolutionPath(HeuristicPuzzleSolver(ManhattanDistance(5)).solve(puzzle)).verify(puzzle))
    ...
    def test_solves_with_zero_heuristic_on_solved_3x3(self):
        puzzle = Puzzle(3)
        self.assertIsNone(SolutionPath(HeuristicPuzzleSolver(NoHeuristic(3)).solve(puzzle)).verify(puzzle))
    ...
    def test_returns_solution_type(self):
        solution = HeuristicPuzzleSolver(ManhattanDistance(3)).solve(Puzzle(3))
    ...
    def test_returns_multi_step_for_scrambled_puzzle(self):
        random.seed(0)
        puzzle = Puzzle(3).shuffle(5)
        solution = HeuristicPuzzleSolver(ManhattanDistance(3)).solve(puzzle)
